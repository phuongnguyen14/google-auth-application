...
To build the final jar and optimize the GoogleAuthApplication application for production, run:
...
[Service Discovery and Configuration with Consul]: https://www.jhipster.tech/documentation-archive/v8.7.1/microservices-architecture/#consul
